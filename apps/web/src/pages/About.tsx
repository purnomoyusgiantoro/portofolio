            ...
            <div className="text-center relative z-10">
              ...
              {settings.cvUrl ? (
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 w-full py-4 bg-primary text-white font-body font-bold text-sm rounded-xl hover:bg-secondary transition-all hover:-translate-y-1 shadow-lg shadow-primary/20"
                >
                  <Download size={18} />
                  Download CV (PDF)
                </a>
                ...
                <button 
                  disabled
                  className="w-full py-4 bg-surface-variant text-black/50 font-body font-bold text-sm rounded-xl cursor-not-allowed border border-outline-variant"
                >
                  CV Belum Tersedia
                </button>
              )}
